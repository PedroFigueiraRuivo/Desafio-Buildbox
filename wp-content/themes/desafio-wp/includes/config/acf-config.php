...
// // Caminho do arquivo JSON que contém as configurações do grupo de campos
// $file_path = HTTFOX_DIRECTORY . '/includes/config/acf-config.json';
...
//     // Importa o grupo de campos usando a função acf_import_field_group()
//     $result = acf_import_field_group($field_group);

//     // Verifica se a importação foi bem-sucedida
//     if ($result) {
//         echo 'As configurações do ACF foram importadas com sucesso!';
//     } else {
//         echo 'Houve um erro ao importar as configurações do ACF.';
//     }
// } else {
//     echo 'O arquivo JSON não foi encontradooo.';
// }
